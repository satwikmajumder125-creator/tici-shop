      ...
      <aside class="shop-sidebar" id="shopSidebar">
        ...
        <div class="filter-section">
          ...
          <div class="price-range">
            <input type="number" name="min_price" placeholder="₹ Min" value="<?= $minPrice ?: '' ?>" min="0" style="width:80px;padding:7px 8px;border:1.5px solid var(--border-strong);border-radius:var(--radius-sm);font-size:.83rem;outline:none">
            <span style="color:var(--text-muted)">—</span>
            <input type="number" name="max_price" placeholder="₹ Max" value="<?= $maxPrice < 99999 ? $maxPrice : '' ?>" min="0" style="width:80px;padding:7px 8px;border:1.5px solid var(--border-strong);border-radius:var(--radius-sm);font-size:.83rem;outline:none">
          </div>
          <button type="submit" class="btn btn-sm btn-primary" style="margin-top:10px;width:100%">Apply</button>
        </div>
